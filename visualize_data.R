...
summary(fed[which(fed$state == "feeding"), ]$duration )
summary(fed[which(fed$state == "resting"), ]$duration )
summary(starved[which(starved$state == "feeding"), ]$duration )
summary(starved[which(starved$state == "resting"), ]$duration )
